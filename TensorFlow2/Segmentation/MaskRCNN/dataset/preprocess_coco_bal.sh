...
TRAIN_IMAGE_DIR="/shared/data/coco_balanced/train2017"

#VAL_IMAGE_FILE="val2017.zip"
#download_and_unzip ${BASE_IMAGE_URL} ${VAL_IMAGE_FILE}
VAL_IMAGE_DIR="/shared/data/coco_balanced/val2017"

#TEST_IMAGE_FILE="test2017.zip"
#download_and_unzip ${BASE_IMAGE_URL} ${TEST_IMAGE_FILE}
TEST_IMAGE_DIR="/shared/data/coco_balanced/test2017"
...
TRAIN_OBJ_ANNOTATIONS_FILE="/shared/data/coco_balanced/annotations/instances_train2017.json"
VAL_OBJ_ANNOTATIONS_FILE="/shared/data/coco_balanced/annotations/instances_val2017.json"

TRAIN_CAPTION_ANNOTATIONS_FILE="/shared/data/coco_balanced/annotations/captions_train2017.json"
VAL_CAPTION_ANNOTATIONS_FILE="/shared/data/coco_balanced/annotations/captions_val2017.json"
